...
Runs eslint on the frontend files. This should also apply the prettier rules as well.
...
2. Follow the Quick Start instructions [here](https://github.com/instructure/canvas-lms/wiki/Quick-Start)
